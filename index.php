...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
          ...
          <a href="login1/php/bienvenida.php" class="nav-item nav-link active">iniciar seccion</a>
        </div>
    ...
    <div class="container">
      ...
      <div class="tab-content lizana">
        ...
        <div id="tab-2" class="tab-pane fade show p-0">
          <div class="row g-4">
            <div class="col-xl-3 col-lg-4 col-md-6 michi">
              <div class="product-item">
                <div class="position-relative bg-light overflow-hidden">
                  <img class="img-fluid w-100" src="img/product-1.jpg" alt="">
                  <div class="bg-secondary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">New</div>
        ...
        <div id="tab-3" class="tab-pane fade show p-0">
          <div class="row g-4">
            ...
            <div class="col-12 text-center verde">
              <a class="btn btn-primary rounded-pill py-3 px-5" href="ola">Browe more Product</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row g-5 align-items-center">
        <div class="col-md-7 wow fadeIn" data-wow-delay="0.1s">
          ...
          <p class="text-white mb-0">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam
            et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet. Diam
            dolor diam ipsum sit. Aliqu diam amet diam et eos.</p>
        </div>
    ...
    <div class="container">
      ...
      <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
        <div class="testimonial-item position-relative bg-white p-5 mt-4">
          ...
          <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit diam amet diam et eos. Clita erat
  ...
  <a href="https://wa.me/987854371?text=Me%20gustaría%20Tener%20Mas%20Informacion" class="whatsapp"
